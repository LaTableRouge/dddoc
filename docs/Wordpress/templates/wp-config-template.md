# Modèle wp-config.php

:::tip
**Security Best Practices:** For a comprehensive WordPress security checklist covering security keys, debug mode, file editing restrictions, and more, see: [WordPress security checklist](https://holdmywp.com/en/wordpress-security-checklist/)
:::

## Fichier wp-config.php en production
...
/* Force security rules on uploads */
define('ALLOW_UNFILTERED_UPLOADS', false);
/* Force security rules on HTML => Mettre à false selon les projets */
...
## Fichier wp-config.php en local
