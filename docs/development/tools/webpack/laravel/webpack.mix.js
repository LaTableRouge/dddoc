...
|--------------------------------------------------------------------------
|
| parce que le laravel mix de base force la compilation dans le dossier public !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
| Force root path for compiled assets
|
*/
...
mix.webpackConfig({
  ...
  ignoreWarnings: [
    {
      message: /process.env.NODE_ENV/, // A RegExp
    }
  ],
  optimization: {
