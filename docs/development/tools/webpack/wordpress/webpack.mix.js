...
/*
 ...
 |
 */
const url = 'http://local.yourproject.com'
const themeName = 'highfive'
const themePath = `./wp-content/themes/${themeName}`
const assetsPath = `${themePath}/assets`
const distPath = isProduction && state === 'build' ? assetsPath : assetsPath
...
const assetsFiles = [
  state === 'build' || state === undefined
    ? {
      ...
      styles: [
        {
          ...
          output: `${distPath}/css/front`
        },
        {
          name: 'style-editor',
          input: `${assetsPath}/scss`,
          output: `${distPath}/css/back`
        },
        {
          name: 'wp-admin',
          input: `${assetsPath}/scss`,
      ...
      php: [`${themePath}/inc/functions`, `${themePath}/functions.php`]
    }
    : null
]
...
|
*/
const filesToVersion = ['index.php']
...
/*
 ...
 |
 */
const fileToClean = [`${themePath}/**/*.php`]
          ...
          if (
            ...
            mix
              .js(
                ...
                isProduction
                  ? `${file.output}/${file.name}.umd.ba.js`
                  : `${file.output}/${file.name}.umd.js`
              )
          }
        })
      }
